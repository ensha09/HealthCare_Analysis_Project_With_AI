"""
Create a Jupyter notebook for the Healthcare ML project
"""
import json, os
...
# ── Imports ──
cells.append(md_cell("## Section 1 — Import Libraries"))
...
# ── Load Dataset ──
cells.append(md_cell("## Section 2 — Load Dataset"))
cells.append(code_cell([
...
cells.append(code_cell("df.describe(include='all')"))

# ── Data Quality ──
cells.append(md_cell("## Section 3 — Data Quality Analysis"))
cells.append(code_cell([
...
# ── Feature Engineering ──
cells.append(md_cell("## Section 4 — Feature Engineering"))
cells.append(code_cell([
...
# ── EDA ──
cells.append(md_cell("## Section 5 — Exploratory Data Analysis"))
cells.append(code_cell([
...
# ── Preprocessing ──
cells.append(md_cell("## Section 6 — Data Preprocessing & Pipeline"))
cells.append(code_cell([
    "TARGET = 'Test Results'\n",
...
# ── Train/Test Split ──
cells.append(md_cell("## Section 7 — Train / Test Split"))
cells.append(code_cell([
...
# ── Train Models ──
cells.append(md_cell("## Section 8 — Train Multiple Models"))
cells.append(code_cell([
    "models = {\n",
...
# ── Model Comparison ──
cells.append(md_cell("## Section 9 — Model Comparison"))
cells.append(code_cell([
...
# ── Best Model ──
cells.append(md_cell("## Section 10 — Best Model & Evaluation"))
cells.append(code_cell([
...
# ── Feature Importance ──
cells.append(md_cell("## Section 11 — Feature Importance"))
cells.append(code_cell([
...
# ── Save Model ──
cells.append(md_cell("## Section 12 — Save & Test Model"))
cells.append(code_cell([
...
with open('notebooks/Data_Analytics_ML_Project.ipynb', 'w', encoding='utf-8') as f:
    json.dump(nb, f, indent=2, ensure_ascii=False)

print("Notebook created: notebooks/Data_Analytics_ML_Project.ipynb")
